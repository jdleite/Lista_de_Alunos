package br.com.room2.ui.activity;
...
import br.com.room2.R;
import br.com.room2.asynctask.BuscaTodosTelefonesDoAlunoTask;
import br.com.room2.asynctask.EditaAlunoTask;
import br.com.room2.asynctask.SalvaAlunoTask;
...
import static br.com.room2.ui.activity.ConstantesActivities.CHAVE_ALUNO;
...
public class FormularioAlunoActivity extends AppCompatActivity {
    ...
    private void salvaAluno(Telefone telefoneFixo, Telefone telefoneCelular) {
        new SalvaAlunoTask(dao, aluno, telefoneFixo, telefoneCelular, telefoneDao, () -> finish()).execute();

    }

    private void editaAluno(Telefone telefoneFixo, Telefone telefoneCelular) {
        new EditaAlunoTask(dao, aluno,
                telefoneFixo,
