package br.com.room2.ui.adapter;
...
import br.com.room2.asynctask.BuscaPrimeiroTelefoneDoAlunoTask;
...
public class ListaAlunosAdapter extends BaseAdapter {
    ...
    private void vincula(View view, Aluno aluno) {
        ...
        new BuscaPrimeiroTelefoneDoAlunoTask(dao, aluno.getId(), telefone1 -> {
